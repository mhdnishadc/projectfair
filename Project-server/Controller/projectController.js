...
exports.addProject = async (req, res) => {
    ...
    try {
        ...
        if (existingProject) {
            res.status(406).json("Project already availble in our system kindly upload another !!!")
        } else {
...
exports.editProjects = async (req,res)=>{
    ...
    try{
        const updatedProject = await projects.findByIdAndUpdate({_id:pid},{
            title,language,overview,github,website,projectImage:uploadImage,userId},{new:true})
